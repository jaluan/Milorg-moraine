...
function out = GoBananas1410_jla(sm,bur_lines)
...
% This should never happen in online use. 
    ...
    sample.production.P14spal=P14_LS(a)*sf_spal*sample.othercorr; %production corrected for sample thickness and topographic shielding
    sample.production.P10spal=P10_LS(a)*sf_spal*sample.othercorr; %production corrected for sample thickness and topographic shielding
...
%         P10_mu(a) = muSt.P_fast_St + muSt.P_neg_St;
        ...
        p10_muons = fit_Pmu_with_exp_LSD_jla(sample.pressure,0,maxZ,2,mconsts,RcEst,consts.SPhiInf,0);
            sample.production.P10_Lm1=p10_muons.L(1); %attenuation, first exponential term
            sample.production.P10_Lm2=p10_muons.L(2); %attenuation, second exponential term
            sample.production.P10_m1 = p10_muons.P(1); %production, first exponential term
            sample.production.P10_m2 = p10_muons.P(2); %production, second exponential term
            ...
            sample.production.P10_m1 = sample.production.P10_m1*shield_fac10_m1*sample.othercorr; % production, first exponential term, corrected for sample thickness and topographic shielding
            sample.production.P10_m2 = sample.production.P10_m2*shield_fac10_m2*sample.othercorr; %production, second exponential term, corrected for sample thickness and topographic shielding
...
%         P14_mu(a) = muLS.P_fast_St + muLS.P_neg_St;
        ...
        p14_muons = fit_Pmu_with_exp_LSD_jla(sample.pressure,0,maxZ,2,mconsts,RcEst,consts.SPhiInf,0);
            sample.production.P14_Lm1=p14_muons.L(1); %attenuation, first exponential term
            sample.production.P14_Lm2=p14_muons.L(2); %attenuation, second exponential term
            sample.production.P14_m1 = p14_muons.P(1); %production, first exponential term
            sample.production.P14_m2 = p14_muons.P(2); %production, second exponential term
            ...
            sample.production.P14_m1 = sample.production.P14_m1*shield_fac14_m1*sample.othercorr; % production, first exponential term, corrected for sample thickness and topographic shielding
            sample.production.P14_m2 = sample.production.P14_m2*shield_fac14_m2*sample.othercorr; %production, second exponential term, corrected for sample thickness and topographic shielding
